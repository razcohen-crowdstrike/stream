...
func (stream SliceMappingStream[E, MapE, ReduceE]) SortFunc(cmp func(a, b E) int) SliceMappingStream[E, MapE, ReduceE] {
	stream.SliceStream = stream.SliceStream.SortFunc(cmp)
	return stream
}
